...
?> 
					...
					<body>
								...
								<div class="banner-form apply-now">
								   <div class="brochure-form thankyou text-center">
									 <div class="text-center thakyou-outer">
										...
										<p class="getintouch">Application Deadline<!-- Extended -->: <br/>March 1, 2022</p>
										<p class="getintouch">Program Starts: <br/>March 2, 2022</p>
										<br>
										<p class="thankyou-padd"><a target="_blank" onclick="trackEvent('click','BDS AP','Redirect','Apply')" class="js-persist-utm blue-btn download-btn-link btn" href="https://em-executive.berkeley.edu/?program_sfid=01t0I000006amj7QAA"> APPLY NOW</a></p>
									</div>
								</div>
							</div>		
							</div>
						...
						<section class="programe-info">
							...
							<p>November 4, 2021</p>
							<h6 class="info">
								<a href="javascript:void(0)" onclick="trackEvent('click','BDS AP','Pop Up','Deadline Extended')" data-toggle="modal" data-target="#myModal2"> <img src="images-new/info_icon.png" alt="info" title="info" class="">&nbsp;<i class="bm">Application deadline extended</i></a>
							</h6> -->
						</div>	
					</div>
					</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="programe-detail">
						...
						<div class="start-text">
							...
							<h6 class="info">
								<b><a href="https://em-executive.berkeley.edu/en/refer/01t0I000006amj7QAA?source=pricing" onclick="trackEvent('click','BDS AP','Redirect','referral');trackAmplitude('Interact with Page','Referral','Redirect');" target="_blank">or get US$285 off with a referral</a></b>
							</h6>
							<h6 class="info">
								<a href="javascript:void(0)" onclick="trackEvent('click','BDS AP','Pop Up','Flexi Pay');trackAmplitude('Interact with Page','Flexi Payment','Popup');" data-toggle="modal" data-target="#myModalFlexi"> <div class="info-icon"></div> <i class="bm">Flexible payment available</i></a>
							</h6>
							<h6 class="info">
								<a href="javascript:void(0)" onclick="trackEvent('click','BDS AP','Pop Up','Enrollment Pricing');showGroupForm();trackAmplitude('Interact with Page','Group Enrollment','Popup');" data-toggle="modal" data-target="#special-group"> <div class="info-icon"></div> <i class="bm">Special group enrollment pricing</i></a>
							</h6>
						</div>	
					</div>
				</div>
				...
				<div class="row col p-0 m-0 ">
					...
					<div class="col-md-3 col-12 item-det">
						...
						<div class="start-text">
							...
							<p><b><a class="know-m" href="https://em-executive.berkeley.edu/en/refer/01t0I000006amj7QAA?source=pricing" onclick="trackEvent('click','BDS AP','Redirect','referral');trackAmplitude('Interact with Page','Referral','Redirect');" target="_blank">or get US$285 off with a referral</a></b></p>
		...
		<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12">
						...
						<a href="#alumni-sec" onclick="trackEvent('click','BDS AP','ScrollDown','Learn More')">Learn More</a>
					</div>
				</div>
		</div>
	</section>
<section class="programe-topic padd40 bg-grey">
	...
	<section class="this-program padd40 bg-grey">
		<div class="container">
			...
			<a href="#download-brochure" class="btns" onclick="trackEvent('click','BDS AP','ScrollUp','Learn More Now')">LEARN MORE NOW</a>
		</div>
	</section>
	...
	<section class="padd40 bg-grey">
		<div class="container">
			...
			<a href="#download-brochure" class="btns" onclick="trackEvent('click','BDS AP','ScrollUp','Download Syllabus');trackAmplitude('Click on CTA','Download syllabus');">DOWNLOAD SYLLABUS</a>
		</div>
	</section>
							...
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="field-data">	
										...
										<p class="Practitioner_text">
											Former chair of the department of economics and faculty director of the Experimental Social Science Lab (Xlab), Prof. Kariv is an expert in behavioral and experimental economics, focused on individuals’ financial and non-financial decisions...<a class="txt-color" data-toggle="modal" data-target="#shachar" onclick="trackEvent('click','BDS AP','Pop Up','More Info Faculty')">More info</a>
										</p>
									</div>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-8 col-md-8 certificate-info">
						...
						<a href="#download-brochure" class="btns" onclick="trackEvent('click','BDS AP','ScrollUp','Earn Certified');trackAmplitude('Click on CTA','Certificate');">EARN CERTIFICATE</a>
					</div>
				</div>
				<div class="clearfix"></div>
	...
	<section class="business-excellence bg-grey">
			...
			<div class="row">
				...
				<div class="col-md-10">
					<p class="small">This program counts toward a <span>Certificate of Business Excellence</span></p>
						...
						up to three years.</p>
						<a href="https://executive.berkeley.edu/certificate-of-business-excellence" target="_blank" onclick="trackEvent('click','BDS AP','Redirect','Learn More');trackAmplitude('Interact with Page','Learn More','Redirect');">Learn more</a>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="applynow padd40 text-center">
			<div class="container">
				<div class="space60">
					<a href="https://em-executive.berkeley.edu/?program_sfid=01t0I000006amj7QAA" onclick="trackEvent('click','BDS AP','Redirect','Apply');trackAmplitude('Click on CTA','Apply Now','Redirect');" target="_blank" class="js-persist-utm btns">APPLY NOW</a>
					<h4>Early registrations are encouraged. Seats fill up quickly!</h4>
					<p>Flexible payment options available. <a href="javascript:void(0);" style="color:#fff !important;text-decoration:underline !important;" data-toggle="modal" data-target="#myModalFlexi" onclick="trackEvent('click','BDS AP','Pop Up','Flexi Pay');trackAmplitude('Interact with Page','Flexi Payment Bottom','Popup');">Learn more</a></p>
				</div>
			</div>
		</section>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header text-center">
							<button type="button" class="close" data-dismiss="modal" onclick="trackEvent('click','BDS AP','Pop Up','Close')">X</button>
						</div>
						<div class="modal-body">
		...
		<div class="model_box">
			<div class="modal fade" id="myModalFlexi" role="dialog">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header text-center">
							<button type="button" class="close" data-dismiss="modal" onclick="trackEvent('click','BDS AP','Pop Up','Close')">&times;</button>
		...
		<div class="model_box">
			<div class="modal fade" id="steve" role="dialog">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header text-center">
							<button type="button" class="close" data-dismiss="modal" onclick="trackEvent('click','BDS AP','Pop Up','More Info Faculty Close')">&times;</button>
						</div>
			...
			<div class="modal fade" id="shachar" role="dialog">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body text-center">
							<img src="images-new/shachar.png" class="img-responsive" width="128" height="128" alt="Shachar Kariv" title="Shachar Kariv">
							<h3>SHACHAR KARIV</h3>
		...
		<a href="https://em-executive.berkeley.edu/?program_sfid=01t0I000006amj7QAA" target="_blank" class="download-bro-btn hide-desktop" onclick="trackAmplitude('Click on CTA','Apply Now Sticky','Apply Now');">Apply Now</a>
