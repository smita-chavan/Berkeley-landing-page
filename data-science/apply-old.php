...
?> 
								...
								<div class="banner-form apply-now">
								   <div class="brochure-form thankyou text-center">
									 <div class="text-center thakyou-outer">
										...
										<p class="getintouch">Application Deadline<!-- Extended -->: <br/>October 26, 2021</p>
										<p class="getintouch">Program Starts: <br/>October 27, 2021</p>
										<br>
							...
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="field-data">	
										...
										<p class="Practitioner_text">
											Shachar is the former department chair and faculty director of the Experimental Social Science Laboratory (Xlab). His research in behavioral and experimental economics provides novel tools for understanding individual preferences and attitudes towards risk and time, which inform nearly all aspects of decision making. The research has uncovered valuable new insights about individuals' financial...<a class="txt-color" data-toggle="modal" data-target="#shachar" onclick="trackEvent('click','BDS AP','Pop Up','More Info Faculty')">More info</a>
										</p>
									</div>
	...
	<section class="alumni-benefits bg-grey padd40">
		<div class="container">
			<div class="">
				<h2 class="title1 text-center">Path to Alumni Benefits</h2>
				<p class="pb">Enrolling in the Data Science program is your first step toward the <b>Certificate of Business Excellence.</b> You will have access to a private global network of more than 41,000 UC Berkeley alumni in more than 80 countries, along with exclusive benefits available only to UC Berkeley alumni:</p>
				<div class="row">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="clearfix content_h5">
								...
								<h6 class="text-center">August 12, 2021</h6>	
						...
						<div class="modal-body">
							...
							<div class="clearfix content_p">
								...
								<ul>
									...
									<li>The final installment of <b>$1,395</b> is to be paid by <b>November 16, 2021</b>.</li>
								</ul>
								<h4>Pay in 3 installments</h4>
								<ul>
									<li>The first installment of <b>$1,077</b> is <b>due immediately</b>.</li>
									<li>The second installment of <b>$958</b> is to be paid by <b>November 16, 2021</b>.</li>
									<li>The final installment of <b>$958</b> is to be paid by <b>December 6, 2021</b>.</li>
								</ul>
							</div>
						</div>
					</div>
