							...
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="field-data">	
										...
										<p class="Practitioner_text">
											Shachar is the former department chair and faculty director of the Experimental Social Science Laboratory (Xlab). His research in behavioral and experimental economics provides novel tools for understanding individual preferences and attitudes towards risk and time, which inform nearly all aspects of decision making. The research has uncovered valuable new insights about individuals' financial...<a class="txt-color" data-toggle="modal" data-target="#shachar" onclick="trackEvent('click','BDS TP','Pop Up','More Info Faculty')">More info</a>
										</p>
									</div>
