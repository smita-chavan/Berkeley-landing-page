...
?> 
						...
						<script data-cookieconsent="ignore" type="text/javascript" src="https://fast.emeritus.org/scripts/custom_forms/290.js" async></script>
				...
				<div class="col-sm-4 col-md-4">
					<div class="programe-detail">
						...
						<div class="start-text">
							...
							<h6 class="info">
								<b><a href="https://em-executive.berkeley.edu/en/refer/01t0I000006amj7QAA?source=pricing" onclick="trackEvent('click','BDS LP','Redirect','referral');trackAmplitude('Interact with Page','Referral','Redirect');" target="_blank">or get US$285 off with a referral</a></b>
							</h6>
							<h6 class="info">
				...
				<div class="row col p-0 m-0 ">
					...
					<div class="col-md-3 col-12 item-det">
						...
						<div class="start-text">
							...
							<p><b><a class="know-m" href="https://em-executive.berkeley.edu/en/refer/01t0I000006amj7QAA?source=pricing" onclick="trackEvent('click','BDS LP','Redirect','referral');trackAmplitude('Interact with Page','Referral','Redirect');" target="_blank">or get US$285 off with a referral</a></b></p>
...
<!-- application detail section-->
		...
		<div class="container">
			<div class="row">
				<h2 class="title1 text-center">Program Modules</h2>
					...
					<p class="note pb padd20 text-center"><i>Note: In order to help you explore some of the hands-on techniques that lead directly to making better data-driven decisions, there will be two weeklong learning labs that provide an opportunity to dig deeper into the data. This extends the program to a total of 10 weeks.</i></p>
				</div>
	...
	<section class="company-example bg-white">
		<div class="container">
			<div class="">
				<h2 class="title1 text-center">Learning Across Industries</h2>
				<div class="examples">
	...
	<section class="participant-profile padd40 bg-grey">
		<div class="container">
			<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-10">
									<div class="field-data">	
										...
										<p class="Practitioner_text">
											Former chair of the department of economics and faculty director of the Experimental Social Science Lab (Xlab), Prof. Kariv is an expert in behavioral and experimental economics, focused on individuals’ financial and non-financial decisions...<a class="txt-color" data-toggle="modal" data-target="#shachar" onclick="trackEvent('click','BDS LP','Pop Up','More Info Faculty')">More info</a>
										</p>
									</div>
