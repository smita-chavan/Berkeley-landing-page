							...
							<div class="container">
								...
								<div class="banner-form">
									<div class="brochure-form">
										<form class="form-horizontal contact-form" role="form" id="frmMain" name="frmMain" method="POST" action="https://em-executive.berkeley.edu/en/native_forms/custom_forms/290/custom_form_entries.json">
											<h2>Request program info</h2>
											<div id="fields">
												<div class="row">
													<div class="form-group">
														<label class="control-label col-xs-4 col-sm-3 col-md-4" for="custom_form_entry_work_experience">First Name <abbr title="required"></abbr></label>
														<div class="col-xs-8 col-sm-9 col-md-8">
															<input required="required" type="text" class="text" name="custom_form_entry[first_name]" id="custom_form_entry_first_name" >
												...
												<div class="row">
													<div class="form-group">
														<label class="control-label col-xs-4 col-sm-3 col-md-4" for="custom_form_entry_work_experience">Last Name <abbr title="required"></abbr></label>
														<div class="col-xs-8 col-sm-9 col-md-8">
														<input required="required" type="text" class="text" name="custom_form_entry[last_name]" id="custom_form_entry_last_name"  >
															<span class="error-text"></span>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="form-group">
														<label class="control-label col-xs-4 col-sm-3 col-md-4" for="custom_form_entry_work_experience">Email <abbr title="required"></abbr></label>
														<div class="col-xs-8 col-sm-9 col-md-8">
														<input required="required" type="email" class="text" name="custom_form_entry[email]" id="custom_form_entry_email" >
															<span class="error-text"></span>
														</div>
													</div>
												</div>	
												<div class="row">
													<div class="form-group">
														<label class="control-label col-xs-4 col-sm-3 col-md-4" for="custom_form_entry_work_experience">Mobile No. <abbr title="required"></abbr></label>
														<div class="col-xs-8 col-sm-9 col-md-8">
														<input required="required" class="text" type="tel" name="custom_form_entry[phone]" id="custom_form_entry_phone" >
															<span class="error-text"></span>
												...
												<div class="row">
													<div class="form-group">
														<label class="control-label col-xs-4 col-sm-3 col-md-4" for="custom_form_entry_work_experience">Work Experience <abbr title="required"></abbr></label>
														<div class="col-xs-8 col-sm-9 col-md-8">
															<select required="required" name="custom_form_entry[work_experience]" id="custom_form_entry_work_experience" class="select">
															<option value=""></option>
															<?php
															$workList		 = getWorkExpList();
															foreach($workList as $expdetail)
															{
																?>
																<option value="<?php echo $expdetail;?>"><?php echo $expdetail;?></option>
																<?php
															}
															?>
															</select>
												...
												<div class="row">
													<div class="form-group">
														<label class="control-label col-xs-4 col-sm-3 col-md-4" for="custom_form_entry_work_experience">Country <abbr title="required"></abbr></label>
														<div class="col-xs-8 col-sm-9 col-md-8">
															<select required="required" name="custom_form_entry[country]" id="custom_form_entry_country" class="select">
																<option value=""></option>
																<?php
												...
												<div class="row">
													<div class="form-group" id="gdpr-consent-frmMain"> 
														<div class="col-sm-12">
															<label class="checkbox-inline">
																<input name="custom_form_entry[agree]" type="hidden" value="0" />
																<input type="checkbox" value="1" name="custom_form_entry[agree]" id="custom_form_entry_agree" style="display:none">
																<div class="consent-text">By clicking the button below, you agree to receive communications from UC Berkeley & Emeritus about this program and other relevant programs. <a href='https://emeritus.org/privacy-policy' target='_blank' class='privacy'>Privacy Policy</a></div>
															</label>
														</div>
													</div>
												</div>
												<div class="form-group">
													<div class="col-sm-12 pd-0 margin-bottom">
														<input type="submit" id="custom_form_entry_submit" class="button btn btn-default download-btn btn-new" value="DOWNLOAD BROCHURE >">
													</div>
												</div>	
												<input type="hidden" name="custom_form_entry[advocate_email]" id="custom_form_entry_advocate_email" />
											  <input type="hidden" name="custom_form_entry[gclid]" id="custom_form_entry_gclid"  value="<?php echo isset($_GET['gclid'])?$xssClean->clean_input(trim($_GET['gclid'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[media_id]" id="custom_form_entry_media_id"  value="<?php echo isset($_GET['media_id'])?$xssClean->clean_input(trim($_GET['media_id'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[user_uuid]" id="custom_form_entry_user_uuid" />
											  <input type="hidden" name="custom_form_entry[utm_ad_id]" id="custom_form_entry_utm_ad_id" value="<?php echo isset($_GET['utm_ad_id'])?$xssClean->clean_input(trim($_GET['utm_ad_id'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_adset_id]" id="custom_form_entry_utm_adset_id" value="<?php echo isset($_GET['utm_adset_id'])?$xssClean->clean_input(trim($_GET['utm_adset_id'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_campaign_id]" id="custom_form_entry_utm_campaign_id" value="<?php echo isset($_GET['utm_campaign_id'])?$xssClean->clean_input(trim($_GET['utm_campaign_id'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_campaign]" id="custom_form_entry_utm_campaign" value="<?php echo isset($_GET['utm_campaign'])?$xssClean->clean_input(trim($_GET['utm_campaign'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_content]" id="custom_form_entry_utm_content" value="<?php echo isset($_GET['utm_content'])?$xssClean->clean_input(trim($_GET['utm_content'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_medium]" id="custom_form_entry_utm_medium" value="<?php echo isset($_GET['utm_medium'])?$xssClean->clean_input(trim($_GET['utm_medium'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_placement]" id="custom_form_entry_utm_placement" value="<?php echo isset($_GET['utm_placement'])?$xssClean->clean_input(trim($_GET['utm_placement'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_source]" id="custom_form_entry_utm_source" value="<?php echo isset($_GET['utm_source'])?$xssClean->clean_input(trim($_GET['utm_source'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[utm_term]" id="custom_form_entry_utm_term" value="<?php echo isset($_GET['utm_term'])?$xssClean->clean_input(trim($_GET['utm_term'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[course_preview]" id="custom_form_entry_course_preview" />
											  <input type="hidden" name="custom_form_entry[fbc]" id="custom_form_entry_fbc"  value="<?php echo isset($_GET['fbc'])?$xssClean->clean_input(trim($_GET['fbc'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[fbp]" id="custom_form_entry_fbp"  value="<?php echo isset($_GET['fbp'])?$xssClean->clean_input(trim($_GET['fbp'])):'';?>"/>
											  <input type="hidden" name="custom_form_entry[incentivized_referral]" id="custom_form_entry_incentivized_referral" />
											  <input type="hidden" name="custom_form_entry[variation_id]" id="custom_form_entry_variation_id" />
											</div>
										</form>
									</div>
...
<script type="text/javascript">
var checkFlg  = 0;
var checkcautiosCountryFlg  = 0;
var explicitOptIn	= "I agree to receive communications from UC Berkeley & Emeritus about this program and other relevant programs. <a href='https://emeritus.org/privacy-policy' target='_blank' class='privacy'>Privacy Policy</a>";
var implicitOptIn   = "By clicking the button below, you agree to receive communications from UC Berkeley & Emeritus about this program and other relevant programs. <a href='https://emeritus.org/privacy-policy' target='_blank' class='privacy'>Privacy Policy</a>";

var countryList = <?php echo json_encode(getCountryCodeList(),JSON_HEX_APOS );?>;
var excludeCountry = <?php echo json_encode(getGDPRCountryCodeList(),JSON_HEX_APOS );?>;

$(document).ready(function(){
	
	$.ajax({
	 url :"https://em-executive.berkeley.edu/en/native_forms/custom_forms/290/custom_form_entries/entry_data",
	 type: 'GET',
	 dataType: "json",
	 xhrFields: {
	 ...
	 success: function(data) {
		...
		jQuery('#custom_form_entry_first_name').val(jsonData['first_name']);
		jQuery('#custom_form_entry_last_name').val(jsonData['last_name']);
		jQuery('#custom_form_entry_email').val(jsonData['email']);
		jQuery('#custom_form_entry_country').val(jsonData['country']);
		if(jQuery.trim(jsonData['country']) != '' )
		{
			jQuery('#custom_form_entry_country').trigger('change');
		}
		jQuery('#custom_form_entry_phone').val(jsonData['phone']);
		jQuery('#custom_form_entry_work_experience').val(jsonData['work_experience']);
		
		
		jQuery('#custom_form_entry_fbc').val(jsonData['fbc']);
		jQuery('#custom_form_entry_fbp').val(jsonData['fbp']);
		if(jQuery('#custom_form_entry_utm_ad_id').val() == "")
		{
			jQuery('#custom_form_entry_utm_ad_id').val(jsonData['utm_ad_id']);
		}
		if(jQuery('#custom_form_entry_utm_adset_id').val() == "")
		{
			jQuery('#custom_form_entry_utm_adset_id').val(jsonData['utm_adset_id']);
		}
		if(jQuery('#custom_form_entry_utm_campaign').val() == "")
		{
			jQuery('#custom_form_entry_utm_campaign').val(jsonData['utm_campaign']);
		}
		if(jQuery('#custom_form_entry_utm_campaign_id').val() == "")
		{
			jQuery('#custom_form_entry_utm_campaign_id').val(jsonData['utm_campaign_id']);
		}
		if(jQuery('#custom_form_entry_utm_content').val() == "")
		{
			jQuery('#custom_form_entry_utm_content').val(jsonData['utm_content']);
		}
		if(jQuery('#custom_form_entry_utm_medium').val() == "")
		{
			jQuery('#custom_form_entry_utm_medium').val(jsonData['utm_medium']);
		}
		
		if(jQuery('#custom_form_entry_utm_placement').val() == "")
		{
			jQuery('#custom_form_entry_utm_placement').val(jsonData['utm_placement']);
		}
		if(jQuery('#custom_form_entry_utm_source').val() == "")
		{	
			jQuery('#custom_form_entry_utm_source').val(jsonData['utm_source']);
		}
		if(jQuery('#custom_form_entry_utm_term').val() == "")
		{	
			jQuery('#custom_form_entry_utm_term').val(jsonData['utm_term']);
		}
		if(jQuery('#custom_form_entry_media_id').val() == "")
		{	
			jQuery('#custom_form_entry_media_id').val(jsonData['media_id']);
		}
		if(jQuery('#custom_form_entry_utm_content').val() == "")
		{
			jQuery('#custom_form_entry_gclid').val(jsonData['gclid']);
		}
	...
	jQuery("#custom_form_entry_country").change(function(){
		$('#apiform-validation-errors').html('');
		$('#apiform-validation-errors').hide();
		if (jQuery(this).val() != "" && jQuery(this).val() != -1) 
		{
			checkFlg = excludeCountry.indexOf($(this).val());
			checkcautiosCountryFlg  = 0;
			jQuery('#custom_form_entry_agree').prop('checked', false); 
			if(checkFlg != -1)
			{
				jQuery('#gdpr-consent-frmMain .consent-text').html(explicitOptIn);
				jQuery('#gdpr-consent-frmMain input[type="checkbox"]').show();
				jQuery('#gdpr-consent-frmMain .col-sm-12').removeClass('p-0');
			}
			else
			{				
				jQuery('#gdpr-consent-frmMain .consent-text').html(implicitOptIn);
				jQuery('#gdpr-consent-frmMain input[type="checkbox"]').hide();
				jQuery('#gdpr-consent-frmMain .col-sm-12').addClass('p-0');
			}
		}
	});
			...
			//event.preventDefault()
			 ...
			 $.ajax({
				 ...
				 error: function(edata) {
					 var errorData = JSON.parse(edata.responseText);
					 console.log(errorData);
					 
					 $.each(errorData.errors, function (i, obj) {
						$('#custom_form_entry_'+i).siblings(".error-text").html(i+" "+obj);
					 });
